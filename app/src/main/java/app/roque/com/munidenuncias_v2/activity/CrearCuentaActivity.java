...
public class CrearCuentaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nombresInput = (EditText)findViewById(R.id.nombres_input);
    ...
    public void callRegister(View view) {
        ...
        if (mediaFileUri == null) {
            ...
            call = service.createUser(username, password, nombres, correo);
        } else {
            ...
            call = service.createUserWithImage(usernamePart, passwordPart, nombresPart,correoPart, imagenPart);
        }
